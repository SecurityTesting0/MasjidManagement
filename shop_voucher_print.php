...
if (empty($_GET['spvid'])){
}elseif(!isset($_GET['spvid']) || $_GET['spvid'] == NULL){
...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(23	,7,'Voucher No:',0,0,'L');
$pdf->Cell(13	,7,'MR-SP-',0,0,'L');
$pdf->Cell(40	,7,$rs['id'],0,0,'L');
$pdf->Cell(20	,7,'Renter A/C:',0,0,'L');
$pdf->Cell(20	,7,$rs['shop_id'],0,1,'L'); 
$pdf->Cell(25	,7,'Renter Name:',0,0,'C');
			...
			while($rs2=$results2->fetch_assoc()){
					...
					$pdf->Cell(65	,7,$rs2['rent_t_name'],0,1,'L'); 
				}
			}
...
$pdf->Cell(65	,5,'Particular',1,0,'C',true);
