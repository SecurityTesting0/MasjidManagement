...
?> 
		...
		<section class="add_new_member ">
			 <div class="container">
				<div class="row">	
					<h3 class="text-center"> EC Members Unpaid List Report Upto <?php  echo $date=date("Y-m-d"); ?></h3>
					...
					<table id="example" class="display table-hover table table-striped table-responsive table-bordered" style="width:100%;">
						...
						<?php	 
							$chk="SELECT member_code FROM members";
								...
								ecms_fees INNER JOIN members ON members.member_code=ecms_fees.members_id
				...
				<div class="col-xs-12 text-center"> 
					<?php	 
						$chk="SELECT member_code FROM members";
							...
							First_name as fname, Last_name as Lname, type from 
							ecms_fees INNER JOIN members ON members.member_code=ecms_fees.members_id
							where ecms_fees.members_id='$mid'"; 
							$results=$db->select($query); 
							$id=0;
							if ($results){
