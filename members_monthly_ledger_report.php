		...
		<section class="add_new_member ">
			 <div class="container">
				...
				<div class="col-sm-10 col-sm-offset-1">
					...
					<h3 class="text-center"> <span style="text-align:center; color:green; font-weight:bold;">All Members Monthly Ledger</span> </h3>
					<br />
					...
					<?php	
						...
						$query="SELECT * FROM `subscription_fees` where invoice_date>= '$from' and invoice_date<= '$to' ";						
					...
					<table id="example" class="display" style="width:95%;">
						...
						<tfoot>
						<?php		
						$query="SELECT SUM(debit_amount) AS debit,SUM(credit_amount) as credit  from `subscription_fees` where invoice_date>= '$from' and invoice_date<= '$to'";
