...
$pdf->SetTextColor(2,112,38);
$pdf->Cell(180	,10,'Committee Member Ledger',0,1,'C');
...
from ecms_fees 
where invoice_date between '2000-01-01' AND date_sub('$from', INTERVAL 1 DAY) 
...
//Table Boday 
$query3="SELECT * FROM `ecms_fees` where members_id='$member_code' and invoice_date>= '$from' and invoice_date<= '$to' ";	 				
...
$pdf->Cell(55	,10,$rs3['narration'],1,0,'C');
