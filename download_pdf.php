...
$pdf->Cell(90	,10,'Mission Para',0,0,'R'); //end of line 16/41, MissionPara Road,Narayanganj Sadar, Narayanganj',0,1,'C'); //end of line 
...
$pdf->Cell(25	,10,'Collect Date',0,0,'L',true);
$pdf->Cell(25	,10,'Invoce Date',0,0,'L',true);
$pdf->Cell(40	,10,'Head',0,0,'L',true);
$pdf->Cell(60	,10,'Narration',0,0,'L',true);
$pdf->Cell(30	,10,'Amount',0,1,'L',true);//end of line
$id=0; 
...
if($getdata==true) {
	...
	$pdf->Cell(25	,9,$getres['date'],0,0,'L',true);
	$pdf->Cell(25	,9,$getres['invoice_date'],0,0,'L',true);
	$pdf->Cell(40	,9,$getres['head'],0,0,'L',true);
	$pdf->cell(55	,9,$getres['narration'],0,0,'',true);
...
if($getdata==true) {
	...
	$pdf->Cell(25	,10,'',0,0,'L',true);
	$pdf->Cell(25	,10,'',0,0,'L',true);
	$pdf->Cell(40	,10,'',0,0,'L',true);
	$pdf->Cell(55	,10,'Total=',0,0,'R',true);
