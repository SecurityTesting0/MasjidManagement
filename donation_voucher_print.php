...
if (empty($_GET['donvid'])){
}elseif(!isset($_GET['donvid']) || $_GET['donvid'] == NULL){
...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(23	,9,'Voucher No:',0,0,'L');
$pdf->Cell(11	,9,'MR-DN-',0,0,'C');
$pdf->Cell(8	,9,$rs['id'],0,1,'C');
$pdf->Cell(20	,9,'Narration:',1,0,'L');
$pdf->Cell(115	,9,$rs['narration'],1,1,'L');  
...
$pdf->Cell(65	,5,'Descripton',1,0,'C',true);
