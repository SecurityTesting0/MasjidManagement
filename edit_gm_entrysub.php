				...
				<div class="row">	
					...
					<?php 
						if(isset($_POST["submit"])){	
							...
							$query ="Update `subscription_fees` SET 
							...
							`gn_date` 		='0000-00-00'
							 ...
							 $results=$db->update($query);
								...
								<a href="gm_voucher_print.php?gmvid='<?php echo $rid; ?>'" class="btn btn-success" target="blank"> Print Money Recpit </a> 
					...
					?>
						...
						<h4 class="well text-center"><span style="color:red; font-weight:bold;">Edit Committee Members Collection</span> <span style="color:green; font-weight:bold;"> Fees </span></h4>
						  ...
						  <form action="" method ="post" enctype="">
							  ...
							  <div class="col-xs-6">
								<label for="ex2">Debbit Amount <span style="color:red">*</span></label>
